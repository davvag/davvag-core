WEBDOCK.component().register(function(exports){
    ...
    function createVue(element){
        ...
        */
        var md5HashFunc = CryptoJS.MD5;
        function loginLogic (crypto, userName, password){
            //this.isLogin=true;
            var self = this;
            var handler = exports.getComponent("login-handler");
            handler.services.login({email: userName,password:password,domain:window.location.hostname}).then(function(result){
                if (result.result)
        ...
        login=new Vue({
            ...
            methods: {
                ...
                login: function () {
                    loginLogic(undefined,this.email, this.password);
                }
