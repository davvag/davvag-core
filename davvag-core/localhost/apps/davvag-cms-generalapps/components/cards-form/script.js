WEBDOCK.component().register(function(exports){
    ...
    function loadCategory(scope){
        if (routeData.id)
        handler.transformers.getCardbyid(routeData.id)
    ...
    function loadValidator(){
        ...
        validator.map ("product.title",true, "You should enter a title");
        validator.map ("product.subtitle",true, "You should enter a title");
    ...
    function submit(){
        ...
        if (!scope.submitErrors){
            ...
            var promiseObj;
            if (routeData.id) promiseObj = handler.transformers.updateCards (product);
            else promiseObj = handler.transformers.insertCards (product);
