...
class LoginService {
    ...
    public function getFacebookLogin($req,$res){
        //App ID
            ...
            $loginUrl = $helper->getLoginUrl('https://'.FBCAPP_DOMAIN.'/components/userapp_social/login-handler/service/FacebookLoginCallback', $permissions);
    ...
    public function getFacebookLoginCallback($req,$res){
        ...
        $fb = new Facebook\Facebook([
            ...
            try {
              ...
              $securityCert->AccessToken=$accessToken->getValue();
              $outObject = Auth::SocialLogin("facebook",$accessToken->getValue());
